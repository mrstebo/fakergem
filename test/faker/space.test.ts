...
describe('Space', () => {
  ...
  describe('#moon', () => {
    it('should return a moon', sinonTest(function(this: typeof sinon) {
  ...
  describe('#galaxy', () => {
    it('should return a galaxy', sinonTest(function(this: typeof sinon) {
  ...
  describe('#nebula', () => {
    it('should return a nebula', sinonTest(function(this: typeof sinon) {
  ...
  describe('#starCluster', () => {
    it('should return a star cluster', sinonTest(function(this: typeof sinon) {
  ...
  describe('#constellation', () => {
    it('should return a constellation', sinonTest(function(this: typeof sinon) {
  ...
  describe('#star', () => {
    it('should return a star', sinonTest(function(this: typeof sinon) {
  ...
  describe('#agency', () => {
    it('should return a agency', sinonTest(function(this: typeof sinon) {
  ...
  describe('#agencyAbv', () => {
    it('should return an agency abbreviation', sinonTest(function(this: typeof sinon) {
  ...
  describe('#nasaSpaceCraft', () => {
    it('should return a NASA space craft', sinonTest(function(this: typeof sinon) {
  ...
  describe('#company', () => {
    it('should return a company', sinonTest(function(this: typeof sinon) {
  ...
  describe('#distanceMeasurement', () => {
    it('should return a distanceMeasurement', sinonTest(function(this: typeof sinon) {
  ...
  describe('#meteorite', () => {
    it('should return a meteorite', sinonTest(function(this: typeof sinon) {
