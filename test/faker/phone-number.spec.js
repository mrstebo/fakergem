...
describe('PhoneNumber', () => {
  describe('#phoneNumber', () => {
    it('should return a phone number', sinonTest(function() {
  ...
  describe('#cellPhone', () => {
    it('should return a cellphone number', sinonTest(function() {
  ...
  describe('#areaCode', () => {
    it('should return an area code', sinonTest(function() {
  ...
  describe('#exchangeCode', () => {
    it('should return an exchange code', sinonTest(function() {
