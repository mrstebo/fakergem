...
describe('Address', () => {
  describe('#city', () => {
    ...
    it('should run the city through the Fake faker', sinonTest(function(this: typeof sinon) {
  ...
  describe('#streetName', () => {
    it('should return a street name', sinonTest(function(this: typeof sinon) {
    ...
    it('should run the street name through the Fake faker', sinonTest(function(this: typeof sinon) {
  ...
  describe('#streetAddress', () => {
    it('should return a street address', sinonTest(function(this: typeof sinon) {
    ...
    it('should run the street address through the Fake faker', sinonTest(function(this: typeof sinon) {
  ...
  describe('#secondaryAddress', () => {
    it('should return a secondary address', sinonTest(function(this: typeof sinon) {
    ...
    it('should run the secondary address through the Fake faker', sinonTest(function(this: typeof sinon) {
  ...
  describe('#buildingNumber', () => {
    it('should return a building number', sinonTest(function(this: typeof sinon) {
  ...
  describe('#zipCode', () => {
    it('should return a post code', sinonTest(function(this: typeof sinon) {
    ...
    it('should run the zip code through the Fake faker', sinonTest(function(this: typeof sinon) {
  ...
  describe('#zip', () => {
    it('should return zipCode', sinonTest(function(this: typeof sinon) {
  ...
  describe('#timeZone', () => {
    it('should return a time zone', sinonTest(function(this: typeof sinon) {
  ...
  describe('#streetSuffix', () => {
    it('should return a street suffix', sinonTest(function(this: typeof sinon) {
  ...
  describe('#citySuffix', () => {
    it('should return a city suffix', sinonTest(function(this: typeof sinon) {
  ...
  describe('#cityPrefix', () => {
    it('should return a city prefix', sinonTest(function(this: typeof sinon) {
  ...
  describe('#stateAbbr', () => {
    it('should return a state abbreviation', sinonTest(function(this: typeof sinon) {
  ...
  describe('#country', () => {
    it('should return a country', sinonTest(function(this: typeof sinon) {
  ...
  describe('#countryCode', () => {
    it('should return a country code', sinonTest(function(this: typeof sinon) {
  ...
  describe('#latitude', () => {
    it('should return a latitude', sinonTest(function(this: typeof sinon) {
  ...
  describe('#longitude', () => {
    it('should return a longitude', sinonTest(function(this: typeof sinon) {
