...
describe('Company', () => {
  describe('#name', () => {
    ...
    it('should run the name through the fake faker', sinonTest(function(this: typeof sinon) {
  ...
  describe('#catchPhrase', () => {
    it('should return a catchPhrase', sinonTest(function(this: typeof sinon) {
  ...
  describe('#buzzword', () => {
    it('should return a buzzword', sinonTest(function(this: typeof sinon) {
      const buzzwords = [
        ...data['buzzwords'][0],
        ...data['buzzwords'][1],
        ...data['buzzwords'][2]
  ...
  describe('#bs', () => {
    it('should return a bs', sinonTest(function(this: typeof sinon) {
      const randomStub = this.stub(Faker.Random, 'element');
  ...
  describe('#ein', () => {
    it('should return an EIN', sinonTest(function(this: typeof sinon) {
  ...
  describe('#dunsNumber', () => {
    it('should return a DUNS Number', sinonTest(function(this: typeof sinon) {
      this.stub(Faker.Number, 'between').withArgs(0, 9).returns(1);
  ...
  describe('#logo', () => {
    it('should return URL to a logo', sinonTest(function(this: typeof sinon) {
  ...
  describe('#swedishOrganisationNumber', () => {
    it('should return a Swedish Organisation Number', sinonTest(function(this: typeof sinon) {
    ...
    it('should handle sums of modulo 10', sinonTest(function(this: typeof sinon) {
      const betweenStub = this.stub(Faker.Number, 'between');
      betweenStub.withArgs(1, 9).returns(1);
  ...
  describe('#norwegianOrganisationNumber', () => {
    it('should return a Norwegian Organisation Number', sinonTest(function(this: typeof sinon) {
  ...
  describe('#profession', () => {
    it('should return a profession', sinonTest(function(this: typeof sinon) {
