const SUPPORTED_CATEGORIES = ['abstract', 'animals', 'business', 'cats', 'city', 'food', 'nightlife', 'fashion', 'people', 'nature', 'sports', 'technics', 'transport'];

export function image(size='300x300', isGray=false, category=null, number=null, text=null) {
  if (!isValidSize(size)) {
